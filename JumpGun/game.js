...
{
	if (region.aT.aa === region.a7.aa)
	{
		return 'on line ' + region.aT.aa;
	}
	return 'on lines ' + region.aT.aa + ' through ' + region.a7.aa;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bd: fragment, bj: host, bz: path, bB: port_, bE: protocol, bF: query};
	});
...
var $author$project$JumpGun$Game$decode = A2(
...
var $author$project$JumpGun$Game$init = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$JumpGun$Game$decode, flags);
	if (!_v0.$) {
		var info = _v0.a;
...
var $author$project$JumpGun$Game$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$JumpGun$Game$update = F2(
	function (msg, model) {
...
var $author$project$JumpGun$Game$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
...
var $author$project$JumpGun$Game$main = $elm$browser$Browser$element(
	{cd: $author$project$JumpGun$Game$init, co: $author$project$JumpGun$Game$subscriptions, cr: $author$project$JumpGun$Game$update, cs: $author$project$JumpGun$Game$view});
_Platform_export({'JumpGun':{'Game':{'init':$author$project$JumpGun$Game$main($elm$json$Json$Decode$value)(0)}}});}(this));